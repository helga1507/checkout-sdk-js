...
import { OverlayPaypal, PaypalCommercePaymentProcessor, PaypalCommercePaymentStrategy, PaypalCommerceRequestSender } from './strategies/paypal-commerce';
...
export default function createPaymentStrategyRegistry(
    ...
    registry.register(PaymentStrategyType.PAYPAL_COMMERCE, () =>
        new PaypalCommercePaymentStrategy(
            ...
            new PaypalCommercePaymentProcessor(new OverlayPaypal())
        )
    );
